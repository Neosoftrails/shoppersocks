...
class ContactUsControllerTest < ActionController::TestCase
  ...
  test "should create contact_u" do
    assert_difference('ContactU.count') do
      post :create, contact_u: { comment: @contact_u.comment, email: @contact_u.email, enquiry: @contact_u.enquiry, name: @contact_u.name, telephone: @contact_u.telephone }
    end
  ...
  test "should update contact_u" do
    put :update, id: @contact_u, contact_u: { comment: @contact_u.comment, email: @contact_u.email, enquiry: @contact_u.enquiry, name: @contact_u.name, telephone: @contact_u.telephone }
    assert_redirected_to contact_u_path(assigns(:contact_u))
  end
